  ...
  return (
    <aside className="w-[260px] bg-dark-card border-r border-dark-border flex flex-col h-screen fixed left-0 top-0 z-40 transition-all duration-300 overflow-y-auto custom-scrollbar shadow-sm">
      ...
      <div className="flex-1 px-3 space-y-6">
        ...
        {(role === UserRole.ADMIN || role === UserRole.PROJECT_MANAGER) &&
        <div>
            <div className="px-4 mb-2 text-xs font-bold text-dark-muted uppercase tracking-wider">HR Tools</div>
            {renderMenuItem('hr-vetting', 'Candidate Vetting', 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z')}
        </div>
        }
